 ...
 <?php
  include 'dbcon.php';
    ...
    if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO `help`(`name`,`city`,`family`,`phone`,`address`) VALUES ('$name','$city','$family','$phone','$address')";
     ...
     if ($result==true) {
      ...
      ?>
    <script>window.open('help.php','_self');</script>
      <?php
    }
    else
    {
        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-angle-double-right"></i> Help Someone</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div style="padding:20px" class="col-sm-12">
                    <h2 style="text-align: center;">Help Someone</h2> <br>
                    ...
                    <div class="row cont-row">
                        ...
                        <div class="col-sm-8"><input type="text" placeholder="Enter Name" name="city" class="form-control input-sm" required ></div>
                    </div>
                    <div class="row cont-row">

                        <div  class="col-sm-3"><label> Family Member </label><span>:</span></div>
                        <div class="col-sm-8"><input type="family" placeholder="Enter Name" name="family" class="form-control input-sm" required ></div>
                    </div>
                    ...
                    <div  class="row cont-row">
                        ...
                        <div class="col-sm-8"><input type="tel" name="address" placeholder="ENTER Amount" class="form-control input-sm" required ></div>
                    </div>
                    <!-- <div  class="row cont-row">
