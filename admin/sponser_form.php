...
<?php
  include 'dbcon.php';
    ...
    if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO `sponser`(`image`,`title`,`price`,`des`) VALUES ('$target_path','$title','$price','$des')";
...
<div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Sponser</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
...
<textarea class="form-control" name="des" placeholder="Des"></textarea>
