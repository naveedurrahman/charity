...
<?php
  include 'dbcon.php';
    ...
    if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO `mach`(`image`,`title`,`price`,`model`,`des`,`location`,`phone`) VALUES ('$target_path','$title','$price','$model','$des','$location','$phone')";
...
<label>Title</label>
 ...
 <label>Type</label>
      <input class="form-control" name="model" placeholder="Type" required><BR>
