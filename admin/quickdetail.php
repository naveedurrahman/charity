...
?>
 ...
 <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Quick Views</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="container-fluid">
    <?php
             ...
             <td><?php //echo $row['city'];?></td> -->
                ...
                <!--<td><img src="<?php #echo $row['product_image'];?>" style="max-width: 100px;" alt=""></td>-->
                 ...
                 <!--<td> <a href=".php?sid=<?php //echo $data[''];?>">
                  ...
                  <td>
       <a href="quick_deleted.php?did=<?php echo $row['id'];?>" onclick="return confirm('Do you really want to delete this ?')">
