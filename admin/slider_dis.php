...
?>
 ...
 <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Slider Views</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="container-fluid">
    <?php
    ...
    ?>
     ...
     <button type="button" class="btn btn-danger"><a href="silder_form.php" style="color: white; text-decoration: none;">Add New Record</a>
     </button>
                                </div>
                                <!-- /.panel-heading -->
