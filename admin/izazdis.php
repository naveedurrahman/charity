...
?>
 ...
 <div id="page-wrapper">
    ...
    ?>
     ...
     <button type="button" class="btn btn-danger"><a href="izazpro.php" style="color: white; text-decoration: none;">Add New Record</a>
     </button>
                                </div>
                                <!-- /.panel-heading -->
    ...
    $selecte = "SELECT * FROM `product`";
                ...
                <!--<td><img src="<?php #echo $row['product_image'];?>" style="max-width: 100px;" alt=""></td>-->
                 ...
                 <!--<td> <a href=".php?sid=<?php echo $data[''];?>">
                  ...
                  <td>
       <a href="product_deleted.php?did=<?php echo $row['prod_id'];?>" onclick="return confirm('Do you really want to delete this ?')">
