...
<?php
  include 'dbcon.php';
    ...
    if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO `product`(`image`,`title`,`price`,`model`,`des`,`location`,`phone`) VALUES ('$target_path','$title','$price','$model','$des','$location','$phone')";
     ...
     if ($result==true) {
      ...
      ?>
    <script>window.open('izazdis.php','_self');</script>
      <?php
    }
    else
    {
