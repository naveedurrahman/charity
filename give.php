 ...
 <?php
  include 'dbcon.php';
    ...
    if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO `give`(`name`,`fromdate`,`todate`,`amount`,`phone`,`email`) VALUES ('$name','$fromdate','$todate','$amount','$phone','$email')";
     ...
     if ($result==true) {
      ...
      ?>
    <script>window.open('give.php','_self');</script>
      <?php
    }
    else
    {
        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-angle-double-right"></i> Give Donation</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div style="padding:20px" class="col-sm-12">
                    <h2 style="text-align: center;">Give Donation</h2> <br>
                    ...
                    <div class="row cont-row">
                        ...
                        <div  class="col-sm-3"><label> From- Date </label><span>:</span></div>
                        <div class="col-sm-8"><input type="date" placeholder="Enter Name" name="fromdate" class="form-control input-sm" required ></div>
                    </div>
                    <div class="row cont-row">

                        <div  class="col-sm-3"><label> To-Date </label><span>:</span></div>
                        <div class="col-sm-8"><input type="date" placeholder="Enter Name" name="todate" class="form-control input-sm" required ></div>
                    </div>
                    ...
                    <div  class="row cont-row">
                        <div  class="col-sm-3"><label>Fund Amount</label><span>:</span></div>
                        <div class="col-sm-8"><input type="tel" name="amount" placeholder="ENTER Amount" class="form-control input-sm" required ></div>
                    </div>
                    <!-- <div  class="row cont-row">
