 ...
 <?php
  include 'dbcon.php';
    ...
    if (isset($_POST['submit'])) {
     ...
     $query = "INSERT INTO `become`(`name`,`fname`,`cnic`,`phone`,`email`) VALUES ('$name','$fname','$cnic','$phone','$email')";
     ...
     if ($result==true) {
      ...
      ?>
    <script>window.open('become.php','_self');</script>
      <?php
    }
    else
    {
...
?>      
    <div class="page-nav no-margin row">
        <div class="container">
            <div class="row">
                <h2>Becom a Volunteer</h2>
                <ul>
                    <li> <a href="#"><i class="fas fa-home"></i> Home</a></li>
                    <li><i class="fas fa-angle-double-right"></i> Becom a Volunteer</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div style="padding:20px" class="col-sm-12">
                    <h2 style="text-align: center;">Becom a Volunteer</h2> <br>
                    ...
                    <div class="row cont-row">
                        ...
                        <div  class="col-sm-3"><label> F-Name </label><span>:</span></div>
                        <div class="col-sm-8"><input type="text" placeholder="Enter Name" name="fname" class="form-control input-sm" required ></div>
                    </div>
                    <div  class="row cont-row">
                    ...
                    <div  class="row cont-row">
                        <div  class="col-sm-3"><label>CNIC</label><span>:</span></div>
                        <div class="col-sm-8"><input type="tel" name="cnic" placeholder="ENTER CNIC" class="form-control input-sm" required ></div>
                    </div>
                    <!-- <div  class="row cont-row">
